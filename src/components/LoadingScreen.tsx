      ...
      <div className="flex flex-col items-center space-y-8">
        {/* اللوجو */}
          ...
          <Image
            ...
            priority
          />
          {/* <h1 className="text-[32px] lg:text-[64px] text-center font-bold transition-colors  text-[#EC221F]">logo</h1> */}
        </div>
        ...
        <div className="flex flex-col items-center space-y-4 w-64">
          ...
          <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#EC221F] rounded-full transition-all duration-300"
